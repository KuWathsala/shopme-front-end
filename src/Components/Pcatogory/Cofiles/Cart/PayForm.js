...
class PayForm extends Component{
    ...
    componentDidMount=()=>{
        axios.get(`https://backend-webapi20190825122524.azurewebsites.net/api/customers/${this.props.userid}`)
        .then(response=>{
...
<form method="post" action="https://sandbox.payhere.lk/pay/checkout" >   
    ...
    Item Details<br/>
    <input type="text" name="order_id" value="item12345" onChange = {e => this.change(e)}/>
    <input type="text" name="item" value="Total" /> <br/><br/>
    <input type="text" name="currency" value="LKR" />
    <input type="text" name="amount" value={this.props.total}/><br/><br/><br/><br/>
    </div> 
    ...
    <input type="submit" value="Buy Now" //onClick={e => this.onSubmit(e)}
     style = {{
